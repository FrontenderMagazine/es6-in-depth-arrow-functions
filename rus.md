...
это оператор, оператор, который «направляется к»!
...
0. Это тоже не новая возможность ES6, а комбинация старых в новом контексте с
с добавлением небольшой путаницы. Сможете разобраться, как это работает?
