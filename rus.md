...
Чтобы поддерживать этот костыль, движок JavaScript в браузере трактует
...
это оператор, оператор, который «стремится к»!
...
отыскать в исходном коде программ написанных на JavaScript и другие виды стрелок, 
как в игре Поиск Предметов, но давайте на этом остановимся, как бы вы не искали,
_одной стрелки всё равно не хватает_.
...
Но теперь этому пришёл конец. Во всех четырёх теперь есть лямбды. Во всех более новых языках
...
зависящие от лямбд библиотеки и тем самым привели к повсеместному
...
неоднозначный символ, так что единственный приём, который вам следует
